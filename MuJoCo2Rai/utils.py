...
def remove_empty_subdirectories(folder_path):
    """
    Recursively removes all empty subdirectories within the given folder.

    Args:
        folder_path (str): The path to the root folder where empty directories should be removed.
